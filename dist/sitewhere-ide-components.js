  ...
  ***************************************************************************** */
  ...
  __vue_render__$3._withStripped = true;
    ...
    const __vue_inject_styles__$3 = function (inject) {
      if (!inject) return
      inject("data-v-b212e07c_0", { source: "\n.tb[data-v-b212e07c] .v-toolbar__content {\n  padding: 0 10px;\n}\n", map: {"version":3,"sources":["/home/ash/Downloads/sitewhere-ide-components/src/components/common/CondensedToolbar.vue"],"names":[],"mappings":";AAqBA;EACA,eAAA;AACA","file":"CondensedToolbar.vue","sourcesContent":["<template>\n  <v-toolbar flat dark dense card color=\"primary\" class=\"tb\" height=\"38\">\n    <slot name=\"icon\" />\n    <v-toolbar-title class=\"white--text body-2 ml-2\">{{ title }}</v-toolbar-title>\n    <slot name=\"left\" />\n    <v-spacer></v-spacer>\n    <slot />\n  </v-toolbar>\n</template>\n\n<script lang=\"ts\">\nimport Vue from \"vue\";\nimport { Component, Prop } from \"sitewhere-ide-common\";\n\n@Component({})\nexport default class CondensedToolbar extends Vue {\n  @Prop() readonly title!: string;\n}\n</script>\n\n<style scoped>\n.tb >>> .v-toolbar__content {\n  padding: 0 10px;\n}\n</style>\n"]}, media: undefined });

    };
    /* scoped */
    const __vue_scope_id__$3 = "data-v-b212e07c";
    /* module identifier */
  ...
  __vue_render__$5._withStripped = true;
    ...
    const __vue_inject_styles__$5 = function (inject) {
      if (!inject) return
      inject("data-v-92b93b22_0", { source: "\n.error-banner[data-v-92b93b22] {\n  z-index: 2000;\n}\n", map: {"version":3,"sources":["/home/ash/Downloads/sitewhere-ide-components/src/components/common/ErrorBanner.vue"],"names":[],"mappings":";AA+CA;EACA,aAAA;AACA","file":"ErrorBanner.vue","sourcesContent":["<template>\n  <v-snackbar class=\"error-banner\" v-if=\"error\" :timeout=\"5000\" error v-model=\"errorDisplayed\">\n    {{ errorMessage }}\n    <v-btn dark flat @click.native=\"errorDisplayed = false\">Close</v-btn>\n  </v-snackbar>\n</template>\n\n<script>\nexport default {\n  data: () => ({\n    errorDisplayed: false\n  }),\n\n  props: [\"error\"],\n\n  watch: {\n    error: function(value) {\n      if (value) {\n        if (this.error.response && this.error.response.status == 503) {\n          this.$data.errorDisplayed = false;\n        } else if (this.error.response || this.error.message) {\n          this.$data.errorDisplayed = true;\n        }\n      }\n    }\n  },\n\n  computed: {\n    errorMessage: function() {\n      if (!this.error) {\n        return \"\";\n      } else if (this.error.response && this.error.response.headers) {\n        if (this.error.response.headers[\"x-sitewhere-error\"]) {\n          return this.error.response.headers[\"x-sitewhere-error\"];\n        } else if (this.error.response.status === 403) {\n          return \"Server Authentication Failed\";\n        }\n      }\n      return this.error.message;\n    }\n  },\n\n  methods: {}\n};\n</script>\n\n<style scoped>\n.error-banner {\n  z-index: 2000;\n}\n</style>\n"]}, media: undefined });

    };
    /* scoped */
    const __vue_scope_id__$5 = "data-v-92b93b22";
    /* module identifier */
  ...
  __vue_render__$7._withStripped = true;
    ...
    const __vue_inject_styles__$7 = function (inject) {
      if (!inject) return
      inject("data-v-cffcb57a_0", { source: "\n.field[data-v-cffcb57a] {\n  text-overflow: ellipsis;\n  white-space: nowrap;\n  overflow: hidden;\n}\n", map: {"version":3,"sources":["/home/ash/Downloads/sitewhere-ide-components/src/components/common/HeaderField.vue"],"names":[],"mappings":";AAsBA;EACA,uBAAA;EACA,mBAAA;EACA,gBAAA;AACA","file":"HeaderField.vue","sourcesContent":["<template>\n  <v-layout row wrap class=\"mb-1\">\n    <v-flex xs4 class=\"text-xs-right subheading pr-4\">\n      <strong>{{ label }}</strong>:\n    </v-flex>\n    <v-flex class=\"field\" xs8>\n      <slot></slot>\n    </v-flex>\n  </v-layout>\n</template>\n\n<script>\nexport default {\n  data: () => ({}),\n\n  props: [\"label\"],\n\n  methods: {}\n};\n</script>\n\n<style scoped>\n.field {\n  text-overflow: ellipsis;\n  white-space: nowrap;\n  overflow: hidden;\n}\n</style>\n"]}, media: undefined });

    };
    /* scoped */
    const __vue_scope_id__$7 = "data-v-cffcb57a";
    /* module identifier */
  ...
  __vue_render__$8._withStripped = true;
    ...
    const __vue_inject_styles__$8 = function (inject) {
      if (!inject) return
      inject("data-v-020ad3f0_0", { source: "\n.faicon[data-v-020ad3f0] {\n  min-height: 30px;\n  text-align: center;\n}\n", map: {"version":3,"sources":["/home/ash/Downloads/sitewhere-ide-components/src/components/common/IconSelector.vue"],"names":[],"mappings":";AAyrCA;EACA,gBAAA;EACA,kBAAA;AACA","file":"IconSelector.vue","sourcesContent":["<template>\n  <v-menu offset-y lazy>\n    <span slot=\"activator\">\n      <v-container fluid class=\"pa-0\">\n        <v-layout row wrap>\n          <v-flex xs12>\n            <v-text-field label=\"Icon\" placeholder=\" \" v-model=\"icon\" prepend-icon=\"image\"/>\n          </v-flex>\n        </v-layout>\n      </v-container>\n    </span>\n    <v-card>\n      <v-container :style=\"ddStyle\" fluid grid-list-sm>\n        <v-layout row wrap>\n          <v-flex class=\"faicon\" xs1 v-for=\"(icon) in iconsSolid\" :key=\"icon\">\n            <v-tooltip left>\n              <font-awesome-icon\n                class=\"faicon text--grey\"\n                :icon=\"icon\"\n                size=\"lg\"\n                @click=\"onIconSelected(icon)\"\n                slot=\"activator\"\n              />\n              <span>{{ icon }}</span>\n            </v-tooltip>\n          </v-flex>\n        </v-layout>\n      </v-container>\n    </v-card>\n  </v-menu>\n</template>\n\n<script>\nexport default {\n  computed: {\n    // Compute style of logo.\n    ddStyle: function() {\n      return {\n        width: \"500px\",\n        \"max-height\": \"400px\",\n        \"overflow-y\": \"scroll\"\n      };\n    },\n    icon: function() {\n      return this.value;\n    }\n  },\n\n  props: [\"value\"],\n\n  methods: {\n    // Called when icon is selected.\n    onIconSelected: function(e) {\n      this.$data.selectedIcon = e;\n      this.$emit(\"input\", e);\n    }\n  },\n\n  data: () => ({\n    active: null,\n    selectedIcon: null,\n    iconsSolid: [\n      \"address-book\",\n      \"address-card\",\n      \"adjust\",\n      \"air-freshener\",\n      \"align-center\",\n      \"align-justify\",\n      \"align-left\",\n      \"align-right\",\n      \"allergies\",\n      \"ambulance\",\n      \"american-sign-language-interpreting\",\n      \"anchor\",\n      \"angle-double-down\",\n      \"angle-double-left\",\n      \"angle-double-right\",\n      \"angle-double-up\",\n      \"angle-down\",\n      \"angle-left\",\n      \"angle-right\",\n      \"angle-up\",\n      \"angry\",\n      \"apple-alt\",\n      \"archive\",\n      \"archway\",\n      \"arrow-alt-circle-down\",\n      \"arrow-alt-circle-left\",\n      \"arrow-alt-circle-right\",\n      \"arrow-alt-circle-up\",\n      \"arrow-circle-down\",\n      \"arrow-circle-left\",\n      \"arrow-circle-right\",\n      \"arrow-circle-up\",\n      \"arrow-down\",\n      \"arrow-left\",\n      \"arrow-right\",\n      \"arrow-up\",\n      \"arrows-alt\",\n      \"arrows-alt-h\",\n      \"arrows-alt-v\",\n      \"assistive-listening-systems\",\n      \"asterisk\",\n      \"at\",\n      \"atlas\",\n      \"atom\",\n      \"audio-description\",\n      \"award\",\n      \"backspace\",\n      \"backward\",\n      \"balance-scale\",\n      \"ban\",\n      \"band-aid\",\n      \"barcode\",\n      \"bars\",\n      \"baseball-ball\",\n      \"basketball-ball\",\n      \"bath\",\n      \"battery-empty\",\n      \"battery-full\",\n      \"battery-half\",\n      \"battery-quarter\",\n      \"battery-three-quarters\",\n      \"bed\",\n      \"beer\",\n      \"bell\",\n      \"bell-slash\",\n      \"bezier-curve\",\n      \"bicycle\",\n      \"binoculars\",\n      \"birthday-cake\",\n      \"blender\",\n      \"blind\",\n      \"bold\",\n      \"bolt\",\n      \"bomb\",\n      \"bone\",\n      \"bong\",\n      \"book\",\n      \"book-open\",\n      \"book-reader\",\n      \"bookmark\",\n      \"bowling-ball\",\n      \"box\",\n      \"box-open\",\n      \"boxes\",\n      \"braille\",\n      \"brain\",\n      \"briefcase\",\n      \"briefcase-medical\",\n      \"broadcast-tower\",\n      \"broom\",\n      \"brush\",\n      \"bug\",\n      \"building\",\n      \"bullhorn\",\n      \"bullseye\",\n      \"burn\",\n      \"bus\",\n      \"bus-alt\",\n      \"calculator\",\n      \"calendar\",\n      \"calendar-alt\",\n      \"calendar-check\",\n      \"calendar-minus\",\n      \"calendar-plus\",\n      \"calendar-times\",\n      \"camera\",\n      \"camera-retro\",\n      \"cannabis\",\n      \"capsules\",\n      \"car\",\n      \"car-alt\",\n      \"car-battery\",\n      \"car-crash\",\n      \"car-side\",\n      \"caret-down\",\n      \"caret-left\",\n      \"caret-right\",\n      \"caret-square-down\",\n      \"caret-square-left\",\n      \"caret-square-right\",\n      \"caret-square-up\",\n      \"caret-up\",\n      \"cart-arrow-down\",\n      \"cart-plus\",\n      \"certificate\",\n      \"chalkboard\",\n      \"chalkboard-teacher\",\n      \"charging-station\",\n      \"chart-area\",\n      \"chart-bar\",\n      \"chart-line\",\n      \"chart-pie\",\n      \"check\",\n      \"check-circle\",\n      \"check-double\",\n      \"check-square\",\n      \"chess\",\n      \"chess-bishop\",\n      \"chess-board\",\n      \"chess-king\",\n      \"chess-knight\",\n      \"chess-pawn\",\n      \"chess-queen\",\n      \"chess-rook\",\n      \"chevron-circle-down\",\n      \"chevron-circle-left\",\n      \"chevron-circle-right\",\n      \"chevron-circle-up\",\n      \"chevron-down\",\n      \"chevron-left\",\n      \"chevron-right\",\n      \"chevron-up\",\n      \"child\",\n      \"church\",\n      \"circle\",\n      \"circle-notch\",\n      \"clipboard\",\n      \"clipboard-check\",\n      \"clipboard-list\",\n      \"clock\",\n      \"clone\",\n      \"closed-captioning\",\n      \"cloud\",\n      \"cloud-download-alt\",\n      \"cloud-upload-alt\",\n      \"cocktail\",\n      \"code\",\n      \"code-branch\",\n      \"coffee\",\n      \"cog\",\n      \"cogs\",\n      \"coins\",\n      \"columns\",\n      \"comment\",\n      \"comment-alt\",\n      \"comment-dots\",\n      \"comment-slash\",\n      \"comments\",\n      \"compact-disc\",\n      \"compass\",\n      \"compress\",\n      \"concierge-bell\",\n      \"cookie\",\n      \"cookie-bite\",\n      \"copy\",\n      \"copyright\",\n      \"couch\",\n      \"credit-card\",\n      \"crop\",\n      \"crop-alt\",\n      \"crosshairs\",\n      \"crow\",\n      \"crown\",\n      \"cube\",\n      \"cubes\",\n      \"cut\",\n      \"database\",\n      \"deaf\",\n      \"desktop\",\n      \"diagnoses\",\n      \"dice\",\n      \"dice-five\",\n      \"dice-four\",\n      \"dice-one\",\n      \"dice-six\",\n      \"dice-three\",\n      \"dice-two\",\n      \"digital-tachograph\",\n      \"directions\",\n      \"divide\",\n      \"dizzy\",\n      \"dna\",\n      \"dollar-sign\",\n      \"dolly\",\n      \"dolly-flatbed\",\n      \"donate\",\n      \"door-closed\",\n      \"door-open\",\n      \"dot-circle\",\n      \"dove\",\n      \"download\",\n      \"drafting-compass\",\n      \"draw-polygon\",\n      \"drum\",\n      \"drum-steelpan\",\n      \"dumbbell\",\n      \"edit\",\n      \"eject\",\n      \"ellipsis-h\",\n      \"ellipsis-v\",\n      \"envelope\",\n      \"envelope-open\",\n      \"envelope-square\",\n      \"equals\",\n      \"eraser\",\n      \"euro-sign\",\n      \"exchange-alt\",\n      \"exclamation\",\n      \"exclamation-circle\",\n      \"exclamation-triangle\",\n      \"expand\",\n      \"expand-arrows-alt\",\n      \"external-link-alt\",\n      \"external-link-square-alt\",\n      \"eye\",\n      \"eye-dropper\",\n      \"eye-slash\",\n      \"fast-backward\",\n      \"fast-forward\",\n      \"fax\",\n      \"feather\",\n      \"feather-alt\",\n      \"female\",\n      \"fighter-jet\",\n      \"file\",\n      \"file-alt\",\n      \"file-archive\",\n      \"file-audio\",\n      \"file-code\",\n      \"file-contract\",\n      \"file-download\",\n      \"file-excel\",\n      \"file-export\",\n      \"file-image\",\n      \"file-import\",\n      \"file-invoice\",\n      \"file-invoice-dollar\",\n      \"file-medical\",\n      \"file-medical-alt\",\n      \"file-pdf\",\n      \"file-powerpoint\",\n      \"file-prescription\",\n      \"file-signature\",\n      \"file-upload\",\n      \"file-video\",\n      \"file-word\",\n      \"fill\",\n      \"fill-drip\",\n      \"film\",\n      \"filter\",\n      \"fingerprint\",\n      \"fire\",\n      \"fire-extinguisher\",\n      \"first-aid\",\n      \"fish\",\n      \"flag\",\n      \"flag-checkered\",\n      \"flask\",\n      \"flushed\",\n      \"folder\",\n      \"folder-open\",\n      \"font\",\n      \"football-ball\",\n      \"forward\",\n      \"frog\",\n      \"frown\",\n      \"frown-open\",\n      \"futbol\",\n      \"gamepad\",\n      \"gas-pump\",\n      \"gavel\",\n      \"gem\",\n      \"genderless\",\n      \"gift\",\n      \"glass-martini\",\n      \"glass-martini-alt\",\n      \"glasses\",\n      \"globe\",\n      \"globe-africa\",\n      \"globe-americas\",\n      \"globe-asia\",\n      \"golf-ball\",\n      \"graduation-cap\",\n      \"greater-than\",\n      \"greater-than-equal\",\n      \"grimace\",\n      \"grin\",\n      \"grin-alt\",\n      \"grin-beam\",\n      \"grin-beam-sweat\",\n      \"grin-hearts\",\n      \"grin-squint\",\n      \"grin-squint-tears\",\n      \"grin-stars\",\n      \"grin-tears\",\n      \"grin-tongue\",\n      \"grin-tongue-squint\",\n      \"grin-tongue-wink\",\n      \"grin-wink\",\n      \"grip-horizontal\",\n      \"grip-vertical\",\n      \"h-square\",\n      \"hand-holding\",\n      \"hand-holding-heart\",\n      \"hand-holding-usd\",\n      \"hand-lizard\",\n      \"hand-paper\",\n      \"hand-peace\",\n      \"hand-point-down\",\n      \"hand-point-left\",\n      \"hand-point-right\",\n      \"hand-point-up\",\n      \"hand-pointer\",\n      \"hand-rock\",\n      \"hand-scissors\",\n      \"hand-spock\",\n      \"hands\",\n      \"hands-helping\",\n      \"handshake\",\n      \"hashtag\",\n      \"hdd\",\n      \"heading\",\n      \"headphones\",\n      \"headphones-alt\",\n      \"helicopter\",\n      \"highlighter\",\n      \"history\",\n      \"hockey-puck\",\n      \"home\",\n      \"hospital\",\n      \"hospital-alt\",\n      \"hospital-symbol\",\n      \"hot-tub\",\n      \"hotel\",\n      \"hourglass\",\n      \"hourglass-end\",\n      \"hourglass-half\",\n      \"hourglass-start\",\n      \"i-cursor\",\n      \"id-badge\",\n      \"id-card\",\n      \"id-card-alt\",\n      \"image\",\n      \"images\",\n      \"inbox\",\n      \"indent\",\n      \"industry\",\n      \"infinity\",\n      \"info\",\n      \"info-circle\",\n      \"italic\",\n      \"joint\",\n      \"key\",\n      \"keyboard\",\n      \"kiss\",\n      \"kiss-beam\",\n      \"kiss-wink-heart\",\n      \"kiwi-bird\",\n      \"language\",\n      \"laptop\",\n      \"laptop-code\",\n      \"laugh\",\n      \"laugh-beam\",\n      \"laugh-squint\",\n      \"laugh-wink\",\n      \"layer-group\",\n      \"leaf\",\n      \"lemon\",\n      \"less-than\",\n      \"less-than-equal\",\n      \"level-down-alt\",\n      \"level-up-alt\",\n      \"life-ring\",\n      \"lightbulb\",\n      \"link\",\n      \"lira-sign\",\n      \"list\",\n      \"list-alt\",\n      \"list-ol\",\n      \"list-ul\",\n      \"location-arrow\",\n      \"lock\",\n      \"lock-open\",\n      \"long-arrow-alt-down\",\n      \"long-arrow-alt-left\",\n      \"long-arrow-alt-right\",\n      \"long-arrow-alt-up\",\n      \"low-vision\",\n      \"luggage-cart\",\n      \"magic\",\n      \"magnet\",\n      \"male\",\n      \"map\",\n      \"map-marked\",\n      \"map-marked-alt\",\n      \"map-marker\",\n      \"map-marker-alt\",\n      \"map-pin\",\n      \"map-signs\",\n      \"marker\",\n      \"mars\",\n      \"mars-double\",\n      \"mars-stroke\",\n      \"mars-stroke-h\",\n      \"mars-stroke-v\",\n      \"medal\",\n      \"medkit\",\n      \"meh\",\n      \"meh-blank\",\n      \"meh-rolling-eyes\",\n      \"memory\",\n      \"mercury\",\n      \"microchip\",\n      \"microphone\",\n      \"microphone-alt\",\n      \"microphone-alt-slash\",\n      \"microphone-slash\",\n      \"microscope\",\n      \"minus\",\n      \"minus-circle\",\n      \"minus-square\",\n      \"mobile\",\n      \"mobile-alt\",\n      \"money-bill\",\n      \"money-bill-alt\",\n      \"money-bill-wave\",\n      \"money-bill-wave-alt\",\n      \"money-check\",\n      \"money-check-alt\",\n      \"monument\",\n      \"moon\",\n      \"mortar-pestle\",\n      \"motorcycle\",\n      \"mouse-pointer\",\n      \"music\",\n      \"neuter\",\n      \"newspaper\",\n      \"not-equal\",\n      \"notes-medical\",\n      \"object-group\",\n      \"object-ungroup\",\n      \"oil-can\",\n      \"outdent\",\n      \"paint-brush\",\n      \"paint-roller\",\n      \"palette\",\n      \"pallet\",\n      \"paper-plane\",\n      \"paperclip\",\n      \"parachute-box\",\n      \"paragraph\",\n      \"parking\",\n      \"passport\",\n      \"paste\",\n      \"pause\",\n      \"pause-circle\",\n      \"paw\",\n      \"pen\",\n      \"pen-alt\",\n      \"pen-fancy\",\n      \"pen-nib\",\n      \"pen-square\",\n      \"pencil-alt\",\n      \"pencil-ruler\",\n      \"people-carry\",\n      \"percent\",\n      \"percentage\",\n      \"phone\",\n      \"phone-slash\",\n      \"phone-square\",\n      \"phone-volume\",\n      \"piggy-bank\",\n      \"pills\",\n      \"plane\",\n      \"plane-arrival\",\n      \"plane-departure\",\n      \"play\",\n      \"play-circle\",\n      \"plug\",\n      \"plus\",\n      \"plus-circle\",\n      \"plus-square\",\n      \"podcast\",\n      \"poo\",\n      \"portrait\",\n      \"pound-sign\",\n      \"power-off\",\n      \"prescription\",\n      \"prescription-bottle\",\n      \"prescription-bottle-alt\",\n      \"print\",\n      \"procedures\",\n      \"project-diagram\",\n      \"puzzle-piece\",\n      \"qrcode\",\n      \"question\",\n      \"question-circle\",\n      \"quidditch\",\n      \"quote-left\",\n      \"quote-right\",\n      \"random\",\n      \"receipt\",\n      \"recycle\",\n      \"redo\",\n      \"redo-alt\",\n      \"registered\",\n      \"reply\",\n      \"reply-all\",\n      \"retweet\",\n      \"ribbon\",\n      \"road\",\n      \"robot\",\n      \"rocket\",\n      \"route\",\n      \"rss\",\n      \"rss-square\",\n      \"ruble-sign\",\n      \"ruler\",\n      \"ruler-combined\",\n      \"ruler-horizontal\",\n      \"ruler-vertical\",\n      \"rupee-sign\",\n      \"sad-cry\",\n      \"sad-tear\",\n      \"save\",\n      \"school\",\n      \"screwdriver\",\n      \"search\",\n      \"search-minus\",\n      \"search-plus\",\n      \"seedling\",\n      \"server\",\n      \"shapes\",\n      \"share\",\n      \"share-alt\",\n      \"share-alt-square\",\n      \"share-square\",\n      \"shekel-sign\",\n      \"shield-alt\",\n      \"ship\",\n      \"shipping-fast\",\n      \"shoe-prints\",\n      \"shopping-bag\",\n      \"shopping-basket\",\n      \"shopping-cart\",\n      \"shower\",\n      \"shuttle-van\",\n      \"sign\",\n      \"sign-in-alt\",\n      \"sign-language\",\n      \"sign-out-alt\",\n      \"signal\",\n      \"signature\",\n      \"sitemap\",\n      \"skull\",\n      \"sliders-h\",\n      \"smile\",\n      \"smile-beam\",\n      \"smile-wink\",\n      \"smoking\",\n      \"smoking-ban\",\n      \"snowflake\",\n      \"solar-panel\",\n      \"sort\",\n      \"sort-alpha-down\",\n      \"sort-alpha-up\",\n      \"sort-amount-down\",\n      \"sort-amount-up\",\n      \"sort-down\",\n      \"sort-numeric-down\",\n      \"sort-numeric-up\",\n      \"sort-up\",\n      \"spa\",\n      \"space-shuttle\",\n      \"spinner\",\n      \"splotch\",\n      \"spray-can\",\n      \"square\",\n      \"square-full\",\n      \"stamp\",\n      \"star\",\n      \"star-half\",\n      \"star-half-alt\",\n      \"star-of-life\",\n      \"step-backward\",\n      \"step-forward\",\n      \"stethoscope\",\n      \"sticky-note\",\n      \"stop\",\n      \"stop-circle\",\n      \"stopwatch\",\n      \"store\",\n      \"store-alt\",\n      \"stream\",\n      \"street-view\",\n      \"strikethrough\",\n      \"stroopwafel\",\n      \"subscript\",\n      \"subway\",\n      \"suitcase\",\n      \"suitcase-rolling\",\n      \"sun\",\n      \"superscript\",\n      \"surprise\",\n      \"swatchbook\",\n      \"swimmer\",\n      \"swimming-pool\",\n      \"sync\",\n      \"sync-alt\",\n      \"syringe\",\n      \"table\",\n      \"table-tennis\",\n      \"tablet\",\n      \"tablet-alt\",\n      \"tablets\",\n      \"tachometer-alt\",\n      \"tag\",\n      \"tags\",\n      \"tape\",\n      \"tasks\",\n      \"taxi\",\n      \"teeth\",\n      \"teeth-open\",\n      \"terminal\",\n      \"text-height\",\n      \"text-width\",\n      \"th\",\n      \"th-large\",\n      \"th-list\",\n      \"theater-masks\",\n      \"thermometer\",\n      \"thermometer-empty\",\n      \"thermometer-full\",\n      \"thermometer-half\",\n      \"thermometer-quarter\",\n      \"thermometer-three-quarters\",\n      \"thumbs-down\",\n      \"thumbs-up\",\n      \"thumbtack\",\n      \"ticket-alt\",\n      \"times\",\n      \"times-circle\",\n      \"tint\",\n      \"tint-slash\",\n      \"tired\",\n      \"toggle-off\",\n      \"toggle-on\",\n      \"toolbox\",\n      \"tooth\",\n      \"trademark\",\n      \"traffic-light\",\n      \"train\",\n      \"transgender\",\n      \"transgender-alt\",\n      \"trash\",\n      \"trash-alt\",\n      \"tree\",\n      \"trophy\",\n      \"truck\",\n      \"truck-loading\",\n      \"truck-monster\",\n      \"truck-moving\",\n      \"truck-pickup\",\n      \"tshirt\",\n      \"tty\",\n      \"tv\",\n      \"umbrella\",\n      \"umbrella-beach\",\n      \"underline\",\n      \"undo\",\n      \"undo-alt\",\n      \"universal-access\",\n      \"university\",\n      \"unlink\",\n      \"unlock\",\n      \"unlock-alt\",\n      \"upload\",\n      \"user\",\n      \"user-alt\",\n      \"user-alt-slash\",\n      \"user-astronaut\",\n      \"user-check\",\n      \"user-circle\",\n      \"user-clock\",\n      \"user-cog\",\n      \"user-edit\",\n      \"user-friends\",\n      \"user-graduate\",\n      \"user-lock\",\n      \"user-md\",\n      \"user-minus\",\n      \"user-ninja\",\n      \"user-plus\",\n      \"user-secret\",\n      \"user-shield\",\n      \"user-slash\",\n      \"user-tag\",\n      \"user-tie\",\n      \"user-times\",\n      \"users\",\n      \"users-cog\",\n      \"utensil-spoon\",\n      \"utensils\",\n      \"vector-square\",\n      \"venus\",\n      \"venus-double\",\n      \"venus-mars\",\n      \"vial\",\n      \"vials\",\n      \"video\",\n      \"video-slash\",\n      \"volleyball-ball\",\n      \"volume-down\",\n      \"volume-off\",\n      \"volume-up\",\n      \"walking\",\n      \"wallet\",\n      \"warehouse\",\n      \"weight\",\n      \"weight-hanging\",\n      \"wheelchair\",\n      \"wifi\",\n      \"window-close\",\n      \"window-maximize\",\n      \"window-minimize\",\n      \"window-restore\",\n      \"wine-glass\",\n      \"wine-glass-alt\",\n      \"won-sign\",\n      \"wrench\",\n      \"x-ray\",\n      \"yen-sign\"\n    ],\n    iconsBrand: [\n      \"500px\",\n      \"accessible-icon\",\n      \"accusoft\",\n      \"adn\",\n      \"adversal\",\n      \"affiliatetheme\",\n      \"algolia\",\n      \"amazon\",\n      \"amazon-pay\",\n      \"amilia\",\n      \"android\",\n      \"angellist\",\n      \"angrycreative\",\n      \"angular\",\n      \"app-store\",\n      \"app-store-ios\",\n      \"apper\",\n      \"apple\",\n      \"apple-pay\",\n      \"asymmetrik\",\n      \"audible\",\n      \"autoprefixer\",\n      \"avianex\",\n      \"aviato\",\n      \"aws\",\n      \"bandcamp\",\n      \"behance\",\n      \"behance-square\",\n      \"bimobject\",\n      \"bitbucket\",\n      \"bitcoin\",\n      \"bity\",\n      \"black-tie\",\n      \"blackberry\",\n      \"blogger\",\n      \"blogger-b\",\n      \"bluetooth\",\n      \"bluetooth-b\",\n      \"btc\",\n      \"buromobelexperte\",\n      \"buysellads\",\n      \"cc-amazon-pay\",\n      \"cc-amex\",\n      \"cc-apple-pay\",\n      \"cc-diners-club\",\n      \"cc-discover\",\n      \"cc-jcb\",\n      \"cc-mastercard\",\n      \"cc-paypal\",\n      \"cc-stripe\",\n      \"cc-visa\",\n      \"centercode\",\n      \"chrome\",\n      \"cloudscale\",\n      \"cloudsmith\",\n      \"cloudversify\",\n      \"vcodepen\",\n      \"codiepie\",\n      \"connectdevelop\",\n      \"contao\",\n      \"cpanel\",\n      \"creative-commons\",\n      \"creative-commons-by\",\n      \"creative-commons-nc\",\n      \"creative-commons-nc-eu\",\n      \"creative-commons-nc-jp\",\n      \"creative-commons-nd\",\n      \"creative-commons-pd\",\n      \"creative-commons-pd-alt\",\n      \"creative-commons-remix\",\n      \"creative-commons-sa\",\n      \"creative-commons-sampling\",\n      \"creative-commons-sampling-plus\",\n      \"creative-commons-share\",\n      \"css3\",\n      \"css3-alt\",\n      \"cuttlefish\",\n      \"d-and-d\",\n      \"dashcube\",\n      \"delicious\",\n      \"deploydog\",\n      \"deskpro\",\n      \"deviantart\",\n      \"digg\",\n      \"digital-ocean\",\n      \"discord\",\n      \"discourse\",\n      \"dochub\",\n      \"docker\",\n      \"draft2digital\",\n      \"dribbble\",\n      \"dribbble-square\",\n      \"dropbox\",\n      \"drupal\",\n      \"dyalog\",\n      \"earlybirds\",\n      \"ebay\",\n      \"edge\",\n      \"elementor\",\n      \"ello\",\n      \"ember\",\n      \"empire\",\n      \"envira\",\n      \"erlang\",\n      \"ethereum\",\n      \"etsy\",\n      \"expeditedssl\",\n      \"facebook\",\n      \"facebook-f\",\n      \"facebook-messenger\",\n      \"facebook-square\",\n      \"firefox\",\n      \"first-order\",\n      \"first-order-alt\",\n      \"firstdraft\",\n      \"flickr\",\n      \"flipboard\",\n      \"fly\",\n      \"font-awesome\",\n      \"font-awesome-alt\",\n      \"font-awesome-flag\",\n      \"fonticons\",\n      \"fonticons-fi\",\n      \"fort-awesome\",\n      \"fort-awesome-alt\",\n      \"forumbee\",\n      \"foursquare\",\n      \"free-code-camp\",\n      \"freebsd\",\n      \"fulcrum\",\n      \"galactic-republic\",\n      \"galactic-senate\",\n      \"get-pocket\",\n      \"gg\",\n      \"gg-circle\",\n      \"git\",\n      \"git-square\",\n      \"github\",\n      \"github-alt\",\n      \"github-square\",\n      \"gitkraken\",\n      \"gitlab\",\n      \"gitter\",\n      \"glide\",\n      \"glide-g\",\n      \"gofore\",\n      \"goodreads\",\n      \"goodreads-g\",\n      \"google\",\n      \"google-drive\",\n      \"google-play\",\n      \"google-plus\",\n      \"google-plus-g\",\n      \"google-plus-square\",\n      \"google-wallet\",\n      \"gratipay\",\n      \"grav\",\n      \"gripfire\",\n      \"grunt\",\n      \"gulp\",\n      \"hacker-news\",\n      \"hacker-news-square\",\n      \"hackerrank\",\n      \"hips\",\n      \"hire-a-helper\",\n      \"hooli\",\n      \"hornbill\",\n      \"hotjar\",\n      \"houzz\",\n      \"html5\",\n      \"hubspot\",\n      \"imdb\",\n      \"instagram\",\n      \"internet-explorer\",\n      \"ioxhost\",\n      \"itunes\",\n      \"itunes-note\",\n      \"java\",\n      \"jedi-order\",\n      \"jenkins\",\n      \"joget\",\n      \"joomla\",\n      \"js\",\n      \"js-square\",\n      \"jsfiddle\",\n      \"kaggle\",\n      \"keybase\",\n      \"keycdn\",\n      \"kickstarter\",\n      \"kickstarter-k\",\n      \"korvue\",\n      \"laravel\",\n      \"lastfm\",\n      \"lastfm-square\",\n      \"leanpub\",\n      \"less\",\n      \"line\",\n      \"linkedin\",\n      \"linkedin-in\",\n      \"linode\",\n      \"linux\",\n      \"lyft\",\n      \"magento\",\n      \"mailchimp\",\n      \"mandalorian\",\n      \"markdown\",\n      \"mastodon\",\n      \"maxcdn\",\n      \"medapps\",\n      \"medium\",\n      \"medium-m\",\n      \"medrt\",\n      \"meetup\",\n      \"megaport\",\n      \"microsoft\",\n      \"mix\",\n      \"mixcloud\",\n      \"mizuni\",\n      \"modx\",\n      \"monero\",\n      \"napster\",\n      \"neos\",\n      \"nimblr\",\n      \"nintendo-switch\",\n      \"node\",\n      \"node-js\",\n      \"npm\",\n      \"ns8\",\n      \"nutritionix\",\n      \"odnoklassniki\",\n      \"odnoklassniki-square\",\n      \"old-republic\",\n      \"opencart\",\n      \"openid\",\n      \"opera\",\n      \"optin-monster\",\n      \"osi\",\n      \"page4\",\n      \"pagelines\",\n      \"palfed\",\n      \"patreon\",\n      \"paypal\",\n      \"periscope\",\n      \"phabricator\",\n      \"phoenix-framework\",\n      \"phoenix-squadron\",\n      \"php\",\n      \"pied-piper\",\n      \"pied-piper-alt\",\n      \"pied-piper-hat\",\n      \"pied-piper-pp\",\n      \"pinterest\",\n      \"pinterest-p\",\n      \"pinterest-square\",\n      \"playstation\",\n      \"product-hunt\",\n      \"pushed\",\n      \"python\",\n      \"qq\",\n      \"quinscape\",\n      \"quora\",\n      \"r-project\",\n      \"ravelry\",\n      \"react\",\n      \"readme\",\n      \"rebel\",\n      \"red-river\",\n      \"reddit\",\n      \"reddit-alien\",\n      \"reddit-square\",\n      \"rendact\",\n      \"renren\",\n      \"replyd\",\n      \"researchgate\",\n      \"resolving\",\n      \"rev\",\n      \"rocketchat\",\n      \"rockrms\",\n      \"safari\",\n      \"sass\",\n      \"schlix\",\n      \"scribd\",\n      \"searchengin\",\n      \"sellcast\",\n      \"sellsy\",\n      \"servicestack\",\n      \"shirtsinbulk\",\n      \"shopware\",\n      \"simplybuilt\",\n      \"sistrix\",\n      \"sith\",\n      \"skyatlas\",\n      \"skype\",\n      \"slack\",\n      \"slack-hash\",\n      \"slideshare\",\n      \"snapchat\",\n      \"snapchat-ghost\",\n      \"snapchat-square\",\n      \"soundcloud\",\n      \"speakap\",\n      \"spotify\",\n      \"squarespace\",\n      \"stack-exchange\",\n      \"stack-overflow\",\n      \"staylinked\",\n      \"steam\",\n      \"steam-square\",\n      \"steam-symbol\",\n      \"sticker-mule\",\n      \"strava\",\n      \"stripe\",\n      \"stripe-s\",\n      \"studiovinari\",\n      \"stumbleupon\",\n      \"stumbleupon-circle\",\n      \"superpowers\",\n      \"supple\",\n      \"telegram\",\n      \"telegram-plane\",\n      \"tencent-weibo\",\n      \"themeco\",\n      \"themeisle\",\n      \"trade-federation\",\n      \"trello\",\n      \"tripadvisor\",\n      \"tumblr\",\n      \"tumblr-square\",\n      \"twitch\",\n      \"twitter\",\n      \"twitter-square\",\n      \"typo3\",\n      \"uber\",\n      \"uikit\",\n      \"uniregistry\",\n      \"untappd\",\n      \"usb\",\n      \"ussunnah\",\n      \"vaadin\",\n      \"viacoin\",\n      \"viadeo\",\n      \"viadeo-square\",\n      \"viber\",\n      \"vimeo\",\n      \"vimeo-square\",\n      \"vimeo-v\",\n      \"vine\",\n      \"vk\",\n      \"vnv\",\n      \"vuejs\",\n      \"weebly\",\n      \"weibo\",\n      \"weixin\",\n      \"whatsapp\",\n      \"whatsapp-square\",\n      \"whmcs\",\n      \"wikipedia-w\",\n      \"windows\",\n      \"wix\",\n      \"wolf-pack-battalion\",\n      \"wordpress\",\n      \"wordpress-simple\",\n      \"wpbeginner\",\n      \"wpexplorer\",\n      \"wpforms\",\n      \"xbox\",\n      \"xing\",\n      \"xing-square\",\n      \"y-combinator\",\n      \"yahoo\",\n      \"yandex\",\n      \"yandex-international\",\n      \"yelp\",\n      \"yoast\",\n      \"youtube\",\n      \"youtube-square\",\n      \"zhihu\"\n    ]\n  })\n};\n</script>\n\n<style scoped>\n.faicon {\n  min-height: 30px;\n  text-align: center;\n}\n</style>\n"]}, media: undefined });

    };
    /* scoped */
    const __vue_scope_id__$8 = "data-v-020ad3f0";
    /* module identifier */
  ...
  __vue_render__$9._withStripped = true;
    ...
    const __vue_inject_styles__$9 = function (inject) {
      if (!inject) return
      inject("data-v-1a5d61dd_0", { source: "\n.zoomer[data-v-1a5d61dd] {\n  position: absolute;\n  top: 0px;\n  left: 0px;\n  bottom: 0px;\n  right: 0px;\n  margin: 10px;\n}\n.zoomed[data-v-1a5d61dd] {\n  transition: all 0.5s ease;\n}\n.zoomed[data-v-1a5d61dd]:hover {\n  transform: scale(1.05);\n}\n", map: {"version":3,"sources":["/home/ash/Downloads/sitewhere-ide-components/src/components/common/ImageZoomOnHover.vue"],"names":[],"mappings":";AA8BA;EACA,kBAAA;EACA,QAAA;EACA,SAAA;EACA,WAAA;EACA,UAAA;EACA,YAAA;AACA;AACA;EACA,yBAAA;AACA;AACA;EACA,sBAAA;AACA","file":"ImageZoomOnHover.vue","sourcesContent":["<template>\n  <div class=\"zoomer\">\n    <div class=\"zoomed\" :style=\"imageStyle\" />\n  </div>\n</template>\n\n<script lang=\"ts\">\nimport Vue from \"vue\";\nimport { Component, Prop } from \"sitewhere-ide-common\";\n\n@Component({})\nexport default class ImageZoomOnHover extends Vue {\n  @Prop() readonly imageUrl!: string;\n\n  // Compute style of image.\n  get imageStyle() {\n    return {\n      \"background-color\": \"#fff\",\n      \"background-image\": \"url(\" + this.imageUrl + \")\",\n      \"background-size\": \"contain\",\n      \"background-position\": \"center\",\n      transition: \"all 0.5s ease\",\n      height: \"100%\",\n      width: \"100%\"\n    };\n  }\n}\n</script>\n\n<style scoped>\n.zoomer {\n  position: absolute;\n  top: 0px;\n  left: 0px;\n  bottom: 0px;\n  right: 0px;\n  margin: 10px;\n}\n.zoomed {\n  transition: all 0.5s ease;\n}\n.zoomed:hover {\n  transform: scale(1.05);\n}\n</style>\n"]}, media: undefined });

    };
    /* scoped */
    const __vue_scope_id__$9 = "data-v-1a5d61dd";
    /* module identifier */
  ...
  __vue_render__$b._withStripped = true;
    ...
    const __vue_inject_styles__$b = function (inject) {
      if (!inject) return
      inject("data-v-7397c87e_0", { source: "\n.overlay[data-v-7397c87e] {\n  position: absolute;\n  top: 0;\n  bottom: 0;\n  left: 0;\n  right: 0;\n}\n", map: {"version":3,"sources":["/home/ash/Downloads/sitewhere-ide-components/src/components/common/LoadingOverlay.vue"],"names":[],"mappings":";AA6BA;EACA,kBAAA;EACA,MAAA;EACA,SAAA;EACA,OAAA;EACA,QAAA;AACA","file":"LoadingOverlay.vue","sourcesContent":["<template>\n  <div class=\"overlay\">\n    <v-container fill-height>\n      <v-layout align-center justify-center column fill-height>\n        <v-flex xs5/>\n        <v-flex xs1>\n          <v-progress-circular size=\"65\" color=\"#666\" class=\"mb-4\" :indeterminate=\"true\"/>\n        </v-flex>\n        <v-flex xs1>\n          <div class=\"subheading\" style=\"color: #666;\">{{ loadingMessage || 'Loading ...' }}</div>\n        </v-flex>\n        <v-flex xs5/>\n      </v-layout>\n    </v-container>\n  </div>\n</template>\n\n<script lang=\"ts\">\nimport { Component, Prop } from \"sitewhere-ide-common\";\n\nimport Vue from \"vue\";\n\n@Component({})\nexport default class LoadingOverlay extends Vue {\n  @Prop() readonly loadingMessage!: string;\n}\n</script>\n\n<style scoped>\n.overlay {\n  position: absolute;\n  top: 0;\n  bottom: 0;\n  left: 0;\n  right: 0;\n}\n</style>\n"]}, media: undefined });

    };
    /* scoped */
    const __vue_scope_id__$b = "data-v-7397c87e";
    /* module identifier */
  ...
  __vue_render__$g._withStripped = true;
    ...
    const __vue_inject_styles__$g = function (inject) {
      if (!inject) return
      inject("data-v-1ff9a78c_0", { source: "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n", map: {"version":3,"sources":[],"names":[],"mappings":"","file":"FormText.vue"}, media: undefined });

    };
    /* scoped */
    const __vue_scope_id__$g = "data-v-1ff9a78c";
    /* module identifier */
  ...
  __vue_render__$m._withStripped = true;
    ...
    const __vue_inject_styles__$m = function (inject) {
      if (!inject) return
      inject("data-v-f0a25d28_0", { source: "\n.list-entry[data-v-f0a25d28] {\n  border: 1px solid #ddd;\n}\n", map: {"version":3,"sources":["/home/ash/Downloads/sitewhere-ide-components/src/components/list/ListEntry.vue"],"names":[],"mappings":";AAeA;EACA,sBAAA;AACA","file":"ListEntry.vue","sourcesContent":["<template>\n  <v-card class=\"list-entry\" flat hover>\n    <slot/>\n  </v-card>\n</template>\n\n<script lang=\"ts\">\nimport Vue from \"vue\";\nimport { Component } from \"sitewhere-ide-common\";\n\n@Component\nexport default class ListEntry extends Vue {}\n</script>\n\n<style scoped>\n.list-entry {\n  border: 1px solid #ddd;\n}\n</style>\n"]}, media: undefined });

    };
    /* scoped */
    const __vue_scope_id__$m = "data-v-f0a25d28";
    /* module identifier */
  ...
  __vue_render__$s._withStripped = true;
    ...
    const __vue_inject_styles__$s = function (inject) {
      if (!inject) return
      inject("data-v-276bea08_0", { source: "\n.flex-rows[data-v-276bea08] {\n  display: flex;\n  flex-direction: column;\n  height: 100%;\n}\n.list-filters[data-v-276bea08] {\n  flex: 0;\n}\n.list-content[data-v-276bea08] {\n  flex: 1;\n  background-color: #eee;\n  overflow-y: auto;\n}\n.list-footer[data-v-276bea08] {\n  flex: 0;\n}\n", map: {"version":3,"sources":["/home/ash/Downloads/sitewhere-ide-components/src/components/list/ListTab.vue"],"names":[],"mappings":";AA0DA;EACA,aAAA;EACA,sBAAA;EACA,YAAA;AACA;AACA;EACA,OAAA;AACA;AACA;EACA,OAAA;EACA,sBAAA;EACA,gBAAA;AACA;AACA;EACA,OAAA;AACA","file":"ListTab.vue","sourcesContent":["<template>\n  <v-tab-item :key=\"tabkey\">\n    <div class=\"flex-rows\">\n      <div class=\"list-filters\">\n        <slot name=\"filters\" />\n      </div>\n      <div class=\"list-content\">\n        <slot v-if=\"hasResults\" />\n        <slot name=\"noresults\" v-else-if=\"noResults\" />\n      </div>\n      <div class=\"list-footer\">\n        <pager :results=\"results\" @pagingUpdated=\"onPagingUpdated\" :pageSizes=\"pageSizes\" />\n      </div>\n    </div>\n    <loading-overlay v-if=\"!loaded\" :loadingMessage=\"loadingMessage\" />\n    <slot name=\"dialogs\" />\n  </v-tab-item>\n</template>\n\n<script lang=\"ts\">\nimport Vue from \"vue\";\n\nimport Pager from \"./Pager.vue\";\nimport LoadingOverlay from \"../common/LoadingOverlay.vue\";\n\nimport { Component, Prop, IPaging, IPageSizes } from \"sitewhere-ide-common\";\n\n@Component({\n  components: {\n    Pager,\n    LoadingOverlay\n  }\n})\nexport default class ListTab extends Vue {\n  @Prop() readonly tabkey!: string;\n  @Prop() readonly pageSizes!: IPageSizes;\n  @Prop() readonly loadingMessage!: string;\n  @Prop() readonly loaded!: boolean;\n  @Prop() readonly results!: { numResults: number; results: {}[] };\n\n  /** Detect whether loaded with results */\n  get hasResults() {\n    return this.loaded && this.results && this.results.numResults > 0;\n  }\n\n  /** Detect whether loaded with no results */\n  get noResults() {\n    return this.loaded && this.results && this.results.numResults === 0;\n  }\n\n  /** Update paging values and run query */\n  onPagingUpdated(paging: IPaging) {\n    this.$emit(\"pagingUpdated\", paging);\n  }\n}\n</script>\n\n<style scoped>\n.flex-rows {\n  display: flex;\n  flex-direction: column;\n  height: 100%;\n}\n.list-filters {\n  flex: 0;\n}\n.list-content {\n  flex: 1;\n  background-color: #eee;\n  overflow-y: auto;\n}\n.list-footer {\n  flex: 0;\n}\n</style>\n"]}, media: undefined });

    };
    /* scoped */
    const __vue_scope_id__$s = "data-v-276bea08";
    /* module identifier */
  ...
  __vue_render__$x._withStripped = true;
    ...
    const __vue_inject_styles__$x = function (inject) {
      if (!inject) return
      inject("data-v-2698bc27_0", { source: "\n.flex-rows[data-v-2698bc27] {\n  display: flex;\n  flex-direction: column;\n  height: 100%;\n}\n.tab-header[data-v-2698bc27] {\n  flex: 0;\n}\n.tab-content[data-v-2698bc27] {\n  flex: 1;\n  background-color: #eee;\n  overflow-y: auto;\n}\n.tab-footer[data-v-2698bc27] {\n  flex: 0;\n}\n", map: {"version":3,"sources":["/home/ash/Downloads/sitewhere-ide-components/src/components/navigation/ContentTab.vue"],"names":[],"mappings":";AAuCA;EACA,aAAA;EACA,sBAAA;EACA,YAAA;AACA;AACA;EACA,OAAA;AACA;AACA;EACA,OAAA;EACA,sBAAA;EACA,gBAAA;AACA;AACA;EACA,OAAA;AACA","file":"ContentTab.vue","sourcesContent":["<template>\n  <v-tab-item :key=\"tabkey\">\n    <div class=\"flex-rows\">\n      <div class=\"tab-header\">\n        <slot name=\"header\" />\n      </div>\n      <div class=\"tab-content\">\n        <slot v-if=\"loaded\" />\n        <v-card style=\"height: 100%\" v-else>\n          <loading-overlay v-if=\"!loaded\" :loadingMessage=\"loadingMessage\" />\n        </v-card>\n      </div>\n      <div class=\"tab-footer\">\n        <slot name=\"footer\" />\n      </div>\n    </div>\n    <slot name=\"dialogs\"></slot>\n  </v-tab-item>\n</template>\n\n<script lang=\"ts\">\nimport Vue from \"vue\";\nimport { Component, Prop } from \"sitewhere-ide-common\";\n\nimport LoadingOverlay from \"../common/LoadingOverlay.vue\";\n\n@Component({\n  components: {\n    LoadingOverlay\n  }\n})\nexport default class ContentTab extends Vue {\n  @Prop() readonly tabkey!: string;\n  @Prop() readonly loadingMessage!: string;\n  @Prop() readonly loaded!: boolean;\n}\n</script>\n\n<style scoped>\n.flex-rows {\n  display: flex;\n  flex-direction: column;\n  height: 100%;\n}\n.tab-header {\n  flex: 0;\n}\n.tab-content {\n  flex: 1;\n  background-color: #eee;\n  overflow-y: auto;\n}\n.tab-footer {\n  flex: 0;\n}\n</style>\n"]}, media: undefined });

    };
    /* scoped */
    const __vue_scope_id__$x = "data-v-2698bc27";
    /* module identifier */
  ...
  __vue_render__$z._withStripped = true;
    ...
    const __vue_inject_styles__$z = function (inject) {
      if (!inject) return
      inject("data-v-d429baf0_0", { source: "\n.flex-rows[data-v-d429baf0] {\n  display: flex;\n  flex-direction: column;\n  height: 100%;\n}\n.tab-header[data-v-d429baf0] {\n  flex: 0;\n}\n.tab-content[data-v-d429baf0] {\n  flex: 1;\n  background-color: #eee;\n  overflow-y: auto;\n}\n.tab-footer[data-v-d429baf0] {\n  flex: 0;\n}\n", map: {"version":3,"sources":["/home/ash/Downloads/sitewhere-ide-components/src/components/navigation/DataTableTab.vue"],"names":[],"mappings":";AA0EA;EACA,aAAA;EACA,sBAAA;EACA,YAAA;AACA;AACA;EACA,OAAA;AACA;AACA;EACA,OAAA;EACA,sBAAA;EACA,gBAAA;AACA;AACA;EACA,OAAA;AACA","file":"DataTableTab.vue","sourcesContent":["<template>\n  <v-tab-item :key=\"tabkey\">\n    <div class=\"flex-rows\">\n      <div class=\"tab-header\">\n        <slot name=\"header\"/>\n      </div>\n      <div class=\"tab-content\">\n        <v-layout row wrap>\n          <v-flex xs12>\n            <v-data-table\n              :headers=\"headers\"\n              :items=\"matches\"\n              :hide-actions=\"true\"\n              :no-data-text=\"noDataText\"\n              :style=\"tableStyle\"\n            >\n              <template v-for=\"(_, slot) of $scopedSlots\" v-slot:[slot]=\"scope\">\n                <slot :name=\"slot\" v-bind=\"scope\"/>\n              </template>\n            </v-data-table>\n          </v-flex>\n        </v-layout>\n      </div>\n      <div class=\"tab-footer\">\n        <pager :results=\"results\" @pagingUpdated=\"onPagingUpdated\" :pageSizes=\"pageSizes\"/>\n      </div>\n    </div>\n    <loading-overlay v-if=\"!loaded\" :loadingMessage=\"loadingMessage\"/>\n    <slot name=\"dialogs\"></slot>\n  </v-tab-item>\n</template>\n\n<script lang=\"ts\">\nimport Vue from \"vue\";\nimport { Component, Prop } from \"sitewhere-ide-common\";\n\nimport Pager from \"../list/Pager.vue\";\nimport LoadingOverlay from \"../common/LoadingOverlay.vue\";\n\nimport { IPaging, IPageSizes, ITableHeaders } from \"sitewhere-ide-common\";\n\n@Component({\n  components: {\n    Pager,\n    LoadingOverlay\n  }\n})\nexport default class DataTableTab extends Vue {\n  @Prop() readonly tabkey!: string;\n  @Prop() readonly headers!: ITableHeaders;\n  @Prop() readonly pageSizes!: IPageSizes;\n  @Prop() readonly noDataText!: string;\n  @Prop() readonly loadingMessage!: string;\n  @Prop() readonly loaded!: boolean;\n  @Prop() readonly results!: { numResults: number; results: {}[] };\n\n  /** Get current matches */\n  get matches(): {}[] {\n    return this.results ? this.results.results : [];\n  }\n\n  /** Dims results when loading */\n  get tableStyle(): {} {\n    return { opacity: this.loaded ? 1.0 : 0.3 };\n  }\n\n  /** Update paging values and run query */\n  onPagingUpdated(paging: IPaging) {\n    this.$emit(\"pagingUpdated\", paging);\n  }\n}\n</script>\n\n<style scoped>\n.flex-rows {\n  display: flex;\n  flex-direction: column;\n  height: 100%;\n}\n.tab-header {\n  flex: 0;\n}\n.tab-content {\n  flex: 1;\n  background-color: #eee;\n  overflow-y: auto;\n}\n.tab-footer {\n  flex: 0;\n}\n</style>\n"]}, media: undefined });

    };
    /* scoped */
    const __vue_scope_id__$z = "data-v-d429baf0";
    /* module identifier */
  ...
  __vue_render__$A._withStripped = true;
    ...
    const __vue_inject_styles__$A = function (inject) {
      if (!inject) return
      inject("data-v-23722292_0", { source: "\n.flex-rows[data-v-23722292] {\n  display: flex;\n  flex-direction: column;\n  height: 100%;\n}\n.tabs-row[data-v-23722292] {\n  flex: 0;\n}\n.tab-items-row[data-v-23722292] {\n  flex: 1;\n  overflow-y: auto;\n}\n.tab-items-row[data-v-23722292] .v-window__container,\n.tab-items-row[data-v-23722292] .v-window-item {\n  height: 100%;\n}\n", map: {"version":3,"sources":["/home/ash/Downloads/sitewhere-ide-components/src/components/navigation/DetailPage.vue"],"names":[],"mappings":";AA+CA;EACA,aAAA;EACA,sBAAA;EACA,YAAA;AACA;AACA;EACA,OAAA;AACA;AACA;EACA,OAAA;EACA,gBAAA;AACA;AACA;;EAEA,YAAA;AACA","file":"DetailPage.vue","sourcesContent":["<template>\n  <navigation-page :icon=\"icon\" :title=\"title\" :loadingMessage=\"loadingMessage\" :loaded=\"loaded\">\n    <template slot=\"header\">\n      <slot name=\"header\"/>\n    </template>\n    <template v-if=\"record\" slot=\"content\">\n      <div class=\"flex-rows\">\n        <v-tabs class=\"tabs-row\" v-model=\"active\">\n          <slot name=\"tabs\"/>\n        </v-tabs>\n        <v-tabs-items class=\"tab-items-row\" v-model=\"active\">\n          <slot name=\"tab-items\"/>\n        </v-tabs-items>\n      </div>\n    </template>\n    <template slot=\"actions\">\n      <slot name=\"actions\"/>\n    </template>\n    <template slot=\"dialogs\">\n      <slot name=\"dialogs\"/>\n    </template>\n  </navigation-page>\n</template>\n\n<script lang=\"ts\">\nimport Vue from \"vue\";\nimport { Component, Prop } from \"sitewhere-ide-common\";\n\nimport NavigationPage from \"../navigation/NavigationPage.vue\";\n\n@Component({\n  components: {\n    NavigationPage\n  }\n})\nexport default class DetailPage extends Vue {\n  @Prop() readonly icon!: string;\n  @Prop() readonly title!: string;\n  @Prop() readonly loadingMessage!: string;\n  @Prop() readonly loaded!: boolean;\n  @Prop() readonly record!: {};\n\n  active: string | null = null;\n}\n</script>\n\n<style scoped>\n.flex-rows {\n  display: flex;\n  flex-direction: column;\n  height: 100%;\n}\n.tabs-row {\n  flex: 0;\n}\n.tab-items-row {\n  flex: 1;\n  overflow-y: auto;\n}\n.tab-items-row >>> .v-window__container,\n.tab-items-row >>> .v-window-item {\n  height: 100%;\n}\n</style>\n"]}, media: undefined });

    };
    /* scoped */
    const __vue_scope_id__$A = "data-v-23722292";
    /* module identifier */
    const __vue_module_identifier__$A = undefined;
    /* functional template */
    const __vue_is_functional_template__$A = false;
  ...
  __vue_render__$B._withStripped = true;
    ...
    const __vue_inject_styles__$B = function (inject) {
      if (!inject) return
      inject("data-v-43b15ac0_0", { source: "\n.right-overlay[data-v-43b15ac0] {\n  position: absolute;\n  right: 0;\n  top: 0;\n}\n", map: {"version":3,"sources":["/home/ash/Downloads/sitewhere-ide-components/src/components/navigation/NavigationHeaderLeft.vue"],"names":[],"mappings":";AAkBA;EACA,kBAAA;EACA,QAAA;EACA,MAAA;AACA","file":"NavigationHeaderLeft.vue","sourcesContent":["<template>\n  <v-card flat style=\"position: relative; height: 100%\">\n    <slot />\n    <div class=\"right-overlay\">\n      <slot name=\"right-overlay\" />\n    </div>\n  </v-card>\n</template>\n\n<script lang=\"ts\">\nimport Vue from \"vue\";\nimport { Component, Prop } from \"sitewhere-ide-common\";\n\n@Component({})\nexport default class NavigationHeaderLeft extends Vue {}\n</script>\n\n<style scoped>\n.right-overlay {\n  position: absolute;\n  right: 0;\n  top: 0;\n}\n</style>\n"]}, media: undefined });

    };
    /* scoped */
    const __vue_scope_id__$B = "data-v-43b15ac0";
    /* module identifier */
    const __vue_module_identifier__$B = undefined;
    /* functional template */
    const __vue_is_functional_template__$B = false;
  ...
  __vue_render__$D._withStripped = true;
    ...
    const __vue_inject_styles__$D = function (inject) {
      if (!inject) return
      inject("data-v-b5a4981e_0", { source: "\n.footer-content[data-v-b5a4981e] {\n  border-top: 1px solid #ddd;\n  width: 100%;\n  height: 100%;\n  color: #666;\n  padding: 7px;\n}\n", map: {"version":3,"sources":["/home/ash/Downloads/sitewhere-ide-components/src/components/navigation/InAppFooter.vue"],"names":[],"mappings":";AAiBA;EACA,0BAAA;EACA,WAAA;EACA,YAAA;EACA,WAAA;EACA,YAAA;AACA","file":"InAppFooter.vue","sourcesContent":["<template>\n  <v-footer app>\n    <div class=\"footer-content\">\n      <slot/>\n    </div>\n  </v-footer>\n</template>\n\n<script lang=\"ts\">\nimport Vue from \"vue\";\nimport { Component } from \"sitewhere-ide-common\";\n\n@Component({})\nexport default class InAppFooter extends Vue {}\n</script>\n\n<style scoped>\n.footer-content {\n  border-top: 1px solid #ddd;\n  width: 100%;\n  height: 100%;\n  color: #666;\n  padding: 7px;\n}\n</style>\n"]}, media: undefined });

    };
    /* scoped */
    const __vue_scope_id__$D = "data-v-b5a4981e";
    /* module identifier */
    const __vue_module_identifier__$D = undefined;
    /* functional template */
    const __vue_is_functional_template__$D = false;
  ...
  __vue_render__$G._withStripped = true;
    ...
    const __vue_inject_styles__$G = function (inject) {
      if (!inject) return
      inject("data-v-05b050a8_0", { source: "\n.navbutton[data-v-05b050a8] {\n  font-size: 22px;\n  padding-left: 6px;\n  color: #666;\n  vertical-align: middle;\n}\n.navbutton[data-v-05b050a8]:hover {\n  color: #999;\n}\n", map: {"version":3,"sources":["/home/ash/Downloads/sitewhere-ide-components/src/components/navigation/NavigationActionButton.vue"],"names":[],"mappings":";AAoCA;EACA,eAAA;EACA,iBAAA;EACA,WAAA;EACA,sBAAA;AACA;AACA;EACA,WAAA;AACA","file":"NavigationActionButton.vue","sourcesContent":["<template>\n  <v-tooltip left>\n    <v-icon\n      v-if=\"material\"\n      class=\"ma-0 ml-1 navbutton\"\n      @click=\"onAction\"\n      slot=\"activator\"\n    >{{ icon }}</v-icon>\n    <font-awesome-icon\n      v-else\n      class=\"ma-1 navbutton\"\n      :icon=\"icon\"\n      @click=\"onAction\"\n      slot=\"activator\"\n    />\n    <span>{{ tooltip }}</span>\n  </v-tooltip>\n</template>\n\n<script lang=\"ts\">\nimport Vue from \"vue\";\nimport { Component, Prop } from \"sitewhere-ide-common\";\n\n@Component({})\nexport default class NavigationActionButton extends Vue {\n  @Prop() readonly icon!: string;\n  @Prop() readonly tooltip!: string;\n  @Prop({ default: false }) readonly material!: boolean;\n\n  onAction() {\n    this.$emit(\"action\");\n  }\n}\n</script>\n\n<style scoped>\n.navbutton {\n  font-size: 22px;\n  padding-left: 6px;\n  color: #666;\n  vertical-align: middle;\n}\n.navbutton:hover {\n  color: #999;\n}\n</style>\n"]}, media: undefined });

    };
    /* scoped */
    const __vue_scope_id__$G = "data-v-05b050a8";
    /* module identifier */
    const __vue_module_identifier__$G = undefined;
    /* functional template */
    const __vue_is_functional_template__$G = false;
